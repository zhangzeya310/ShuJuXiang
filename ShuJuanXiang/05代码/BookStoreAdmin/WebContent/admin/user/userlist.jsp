                            ...
                            <div class="content">
                                <table class="no-border">
                                    <thead class="no-border">
                                        <tr>
                                            ...
                                            <th class="text-center" style="width:10%;"><strong>昵称</strong></th>
                                            <th class="text-center" style="width:10%;"><strong>用户密码</strong></th>
                                            <th class="text-center" style="width:10%;"><strong>注册时间</strong></th>
                                            <th class="text-center" style="width:10%;"><strong>状态</strong></th>
                                            <th class="text-center" style="width:10%;"><strong>用户地址</strong></th>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a href="/admin/user.do?doWhat=editUser&userUid=${user.uid}"><i class="fa fa-eye"></i>查看并修改用户信息</a></li>
                                                            <li class="divider"></li>
                                                            <li class="delete" data-modal="colored-danger"><a href="/admin/user.do?doWhat=deleteUser&uid=${user.uid}"><i class="fa fa-times"></i>删除该用户</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
	                                        </tr>
                                ...
                                <div class="col-sm-offset-4 col-sm-6">
                                    <ul class="pagination pagination-sm">
                                        ...
                                        <form method="post" action="${pageContext.request.contextPath}/admin/user.do?doWhat=listUser" name="myform">
