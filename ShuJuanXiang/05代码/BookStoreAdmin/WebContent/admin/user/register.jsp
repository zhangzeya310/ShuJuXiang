	...
	<div id="cl-wrapper" class="sign-up-container">
		<div class="middle-sign-up">
			<div class="block-flat">
				...
				<div>
					<form style="margin-bottom: 0px !important;" class="form-horizontal" action="${request.getContextPath}/admin/login.do?doWhat=register" method="POST">
						<div class="content">
							...
							<p class="spacer">我已经有帐号了<a href="${request.getContextPath}/admin/user/login.jsp">立即登录</a></p>
