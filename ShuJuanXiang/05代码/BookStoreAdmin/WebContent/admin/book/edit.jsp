                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
						<div class="block-flat">
						    ...
						    <div class="content">
						        <form class="form-horizontal group-border-dashed" action="/admin/book.do?doWhat=updateBook&bid=${bid}" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-2 col-md-2 control-label">图书简介</label>
										<div class="col-sm-6 col-md-6">
									...
									<div class="form-group">
										<label class="col-sm-2 col-md-2 control-label">管理员评论</label>
										<div class="col-sm-6 col-md-6">
											<textarea  name="editorcomment" class="form-control"></textarea>
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-2 col-md-2 control-label">作者简介</label>
										<div class="col-sm-6 col-md-6">
											<textarea  name="authordescription" class="form-control"></textarea>
										</div>
									</div>

						            <div class="form-group">
						                <label class="col-sm-2 col-md-2 control-label">图片</label>
						                <div class="col-sm-6 col-md-6">
