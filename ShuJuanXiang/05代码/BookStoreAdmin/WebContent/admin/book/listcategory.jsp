                            ...
                            <div class="header">
                                ...
                                <div class="content">
                                    <table class="no-border">
                                        ...
                                        <tr>
                                            <th class="text-center" style="width:20%;"><strong>名称</strong></th>
                                            <th class="text-center" style="width:20%;"><strong>操作</strong></th>
                                        </tr>
                                        </thead>

                                        <tbody class="no-border-y">

                                        <td class="text-center">${sc.categoryName}dsf</td>
                                        <td class="text-center">
                                            <a href="/admin/login.do?doWhat=deleteAdmin&uid=${sc.categoryId}"
                                               class="btn btn-danger btn-xs"><i class="fa fa-times"></i>删除该分类</a>
                                       ...
                                       <td class="text-center">
                                           <table class="no-border">
                                               ...
                                               <td class="text-center">
                                                   <tbody class="no-border-y" style="padding-right: 40%">
                                                   <%--<c:forEach items="${secondCates}" var="sc">--%>
                                                   <tr>
                                                       <td><input type="checkbox" class="icheck"></td>
                                                       <td class="text-center">${sc.secondCategoryId}asdfa</td>
                                                       <td class="text-center">${sc.secondCategoryName}asfd</td>
                                                       <td class="text-center">
                                                           <a href="/admin/login.do?doWhat=deleteAdmin&uid=${sc.secondCategoryId}"
                                                              class="btn btn-danger btn-xs"><i
                                                                   class="fa fa-times"></i>删除该分类2</a>
                                                       </td>
                                                   </tr>
                                        ...
                                        <td class="text-center">
                                            <table class="">
                                                ...
                                                <td class="text-center">
                                                    <tbody class="no-border-y" style="margin-right: 40%">
                                                    <%--<c:forEach items="${secondCates}" var="sc">--%>
                                                    <tr>
                                                        <td><input type="checkbox" class="icheck"></td>
                                                        <td class="text-center">${sc.secondCategoryId}asdfa</td>
