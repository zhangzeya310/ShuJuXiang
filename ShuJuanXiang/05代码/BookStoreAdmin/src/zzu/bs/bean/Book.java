...
public class Book implements Serializable {
	...
	public Book(String name, String author, Double price, Integer discount, String publishing, String publishTime,
			...
			String pack, String editorComment, String authordescription, String floor) {
		super();
		this.name = name;
		this.author = author;
		this.price = price;
	...
	public Book(Integer bid, String name, String author, Double price, Integer discount, String publishing,
			...
			String bookformat, String pack, String editorComment, String authordescription, String floor) {
		super();
		this.bid = bid;
		this.name = name;
		this.author = author;
